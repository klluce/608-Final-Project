...
# Recall how our categories of the top body types are distributed in the dataset:

# In[32]:


upfits_subset["body_type_top5"].value_counts()


# In[33]:


upfits_subset["body_type_top5"].value_counts(normalize=True)
...
buyer_dtt = alt.Chart(upfits_subset).mark_circle().encode(
    x=alt.X("buyer_engagements").title("Buyer Engagements"),
    y=alt.Y("dtt").title("Days to Turn"),
    color=alt.Color("body_type_top5").title("Body Type Category")
)
buyer_dtt
