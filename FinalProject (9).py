...
# What is the largest category of Body type? How fast does that body type sell, i.e., what is its Average DTT (days to turn)?
...
buyer_searches = alt.Chart(upfits_top5_only).mark_circle().encode(
    ...
    y=alt.Y("dtt").title("Days to Turn"),
...
#limiting to only service trucks
